...
and vof_expr =
  ...
  | Unary ((v1, v2)) ->
      let v1 = vof_wrap Meta_ast_generic.vof_arithmetic_operator v1
      and v2 = vof_expr v2
  ...
  | Infix ((v1, v2, v3)) ->
      let v1 = vof_expr v1
      and v2 = vof_wrap Meta_ast_generic.vof_arithmetic_operator v2
      and v3 = vof_expr v3
...
and vof_op v = vof_wrap Meta_ast_generic.vof_incr_decr v
and vof_stmt =
  function
